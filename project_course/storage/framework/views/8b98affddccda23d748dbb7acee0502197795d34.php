    ...
    <div class="container">
        <div class="row row-pb-md">
            ...
            <div class="col-md-4 col-sm-8 col-xs-12 col-md-push-1">
                ...
                <ul class="fh5co-footer-links">
                    ...
                    <li><a href="mailto:<?php echo e(env('MAIL_FROM_ADDRESS')); ?>"><?php echo e(env('MAIL_FROM_ADDRESS')); ?></a></li>
                    <li><p><?php echo e(env('CLIENT_DATA_TELEPHONE')); ?></p></li>
                </ul>
            </div>
        </div>
        ...
        <div class="row copyright">
            <div class="col-md-12 text-center">
                ...
                <p>
                    <small class="block">&copy; <?php echo e(date('Y')); ?> UpInside Treinamentos. Todos os Direitos Reservados.
                    </small>
                    <small class="block">

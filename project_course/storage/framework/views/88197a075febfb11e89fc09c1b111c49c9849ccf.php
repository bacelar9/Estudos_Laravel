<?php $__env->startSection('content'); ?>
                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <div class="display-t">
                        <div class="display-tc animate-box" data-animate-effect="fadeIn">
                            ...
                            <p><a class="btn btn-primary btn-lg btn-learn" href="<?php echo e(route('course')); ?>">Conhecer o Curso</a> <a
    ...
    <?php echo $__env->make('front.includes.testimonials', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="fh5co-blog animate-box">
                        <a href="<?php echo e(route('article', $post->uri)); ?>">

...
@section('content')
	...
	<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(front/assets/images/img_bg_1.jpg);" data-stellar-background-ratio="0.5">
	...
	<div id="fh5co-project">
		...
		<div class="container-fluid proj-bottom">
			<div class="row">
				...
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="front/assets/clsimages/project-3.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Read Bible</h3>
						<span>View Course</span>
					</a>
				</div>
